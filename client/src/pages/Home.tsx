...
const audience = [
  "طلبة الجامعات المهتمون بالتقنية والطاقة والابتكار وريادة الأعمال.",
  "المطورون والمبرمجون الراغبون في بناء حلول رقمية ذات أثر عملي.",
  "المبتكرون ورواد الأعمال ممن يملكون أفكارًا قابلة للتحويل إلى مشاريع.",
  "الباحثون والمهتمون بالتقنيات الناشئة والتطبيقات المؤسسية.",
  "المهتمون بحل التحديات الواقعية في مجالات الطاقة والخدمات والبيانات والعمليات.",
];
...
const faqItems = [
  ...
  },
  {
    ...
    a: "يستهدف المعسكر طلبة الجامعات، والمطورين، والمبتكرين، والباحثين، وكل من لديه اهتمام ببناء حلول تقنية ذات أثر عملي في المجالات المطروحة.",
  },
  {
    ...
    <div dir="rtl" className="min-h-screen bg-[var(--page-bg)] text-[var(--brand-ink)]">
      ...
      <main>
        ...
        <ListCardSection
          ...
          body="صُمم المعسكر ليستقطب مجتمعًا متنوعًا من المهتمين بالتقنية والابتكار وبناء الحلول التطبيقية في مجالات الطاقة والخدمات والبيانات."
          items={audience}
          columns={2}
        />
        <AwardsSection />
